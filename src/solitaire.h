...
private:
    ...
    ******************************************/
    void init(BOARDSHAPE shape);

    // Sets up the board fr
    ...
    void initializeMemoryBoard();

    // Saves the board to a string in order to be able
    // to compare it's state in the testing functions
